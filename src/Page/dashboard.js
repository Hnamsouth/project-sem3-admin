                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>
                                                <div class="flag">
                                                    <img src="../admin/assets/img/flags/US.png"/> </div>
                                                </td>
                                                <td>USA</td>
                                                <td class="text-right">
                                                2.920
                                            ...
                                            <tr>
                                                <td>
                                                <div class="flag">
                                                    <img src="../admin/assets/img/flags/DE.png"/> </div>
                                                </td>
                                                <td>Germany</td>
                                                <td class="text-right">
                                                1.300
                                            ...
                                            <tr>
                                                <td>
                                                <div class="flag">
                                                    <img src="../admin/assets/img/flags/AU.png"/> </div>
                                                </td>
                                                <td>Australia</td>
                                                <td class="text-right">
                                                760
                                            ...
                                            <tr>
                                                <td>
                                                <div class="flag">
                                                    <img src="../admin/assets/img/flags/GB.png"/> </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                <div class="flag">
                                                    <img src="../admin/assets/img/flags/RO.png"/> </div>
                                                </td>
                                                <td>Romania</td>
                                                <td class="text-right">
                                                600
                                            ...
                                            <tr>
                                                <td>
                                                <div class="flag">
                                                    <img src="../admin/assets/img/flags/BR.png"/> </div>
                                                </td>
                                                <td>Brasil</td>
                                                <td class="text-right">
                                                550
                                        ...
                                        <div class="col-md-6 ml-auto mr-auto">
                                            <div id="worldMap" style={{height:300+'px'}}></div>
                                        </div>
                                        </div>
                                        </div>
                                        </div>
